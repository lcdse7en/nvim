...
local normal_mode_mappings = {
  ...
  g = {
    ...
    m = { "blame line" },
    r = { "<cmd>Lspsaga rename<CR>", "Lspsaga rename" },
    f = { "<cmd>Lspsaga lsp_finder<CR>", "Lspsaga finder" },
  ...
  f = {
    ...
    l = { "<cmd>ToggleTerm direction=float<cr>lfub<cr>", "Open LF" },
